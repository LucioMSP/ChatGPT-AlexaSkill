...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Hola mi cuate, ¿qué te gustaría saber?';
...
const speakOutput = response.data.choices[0].text + ' ¿qué más te gustaría saber?';
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Vámonos que aquí espantan....!';
